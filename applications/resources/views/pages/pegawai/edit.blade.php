        ...
        <div class="box-body">
          <div class="form-group {{ $errors->has('nama_pegawai') ? 'has-error' : '' }}">
            ...
            <div class="col-sm-9">
              ...
              <input type="text" name="nama_pegawai" class="form-control" value="{{ $pegawai->nama }}" placeholder="@if($errors->has('nama_pegawai')){{ $errors->first('nama_pegawai')}}@endif Nama">
            </div>
          </div>
          <div class="form-group {{ $errors->has('nip_sapk') ? 'has-error' : '' }}">
            <label class="col-sm-3 control-label">NIP</label>
            <div class="col-sm-9">
              <input type="text" name="nip_sapk" class="form-control" value="{{ $pegawai->nip_sapk }}" placeholder="@if($errors->has('nip_sapk')){{ $errors->first('nip_sapk')}}@endif NIP">
            </div>
          </div>
          <div class="form-group {{ $errors->has('nip_lm') ? 'has-error' : '' }}">
            <label class="col-sm-3 control-label">NIP Lama</label>
            <div class="col-sm-9">
              <input type="text" name="nip_lm" class="form-control" value="{{ $pegawai->nip_lm }}" placeholder="@if($errors->has('nip_lm')){{ $errors->first('nip_lm')}}@endif NIP Lama">
            </div>
          </div>
          <div class="form-group {{ $errors->has('fid') ? 'has-error' : '' }}">
            <label class="col-sm-3 control-label">Finger ID</label>
            <div class="col-sm-9">
              <input type="text" name="fid" class="form-control" value="{{ $pegawai->fid }}" onkeypress="return isNumber(event)" placeholder="@if($errors->has('fid')){{ $errors->first('fid')}}@endif Finger ID" maxlength="14">
              @if($errors->has('fid'))
          ...
          <div class="form-group {{ $errors->has('tanggal_lahir') ? 'has-error' : '' }}">
            ...
            <div class="col-sm-9">
              <div class="input-group date">
                ...
                <input class="form-control pull-right" id="datepicker1" type="text" name="tanggal_lahir"  value="{{ $pegawai->tanggal_lahir }}" placeholder="@if($errors->has('tanggal_lahir')){{ $errors->first('tanggal_lahir')}}@endif Tanggal Lahir">
              </div>
            </div>
          </div>
          <div class="form-group {{ $errors->has('tempat_lahir') ? 'has-error' : '' }}">
            ...
            <div class="col-sm-9">
              <input type="text" name="tempat_lahir" class="form-control" value="{{ $pegawai->tempat_lahir }}" placeholder="@if($errors->has('tempat_lahir')){{ $errors->first('tempat_lahir')}}@endif Tempat Lahir">
            </div>
          </div>
          ...
          <div class="form-group {{ $errors->has('alamat') ? 'has-error' : '' }}">
            ...
            <div class="col-sm-9">
              <input type="text" name="alamat" class="form-control" value="{{ $pegawai->alamat }}" placeholder="@if($errors->has('alamat')){{ $errors->first('alamat')}}@endif Alamat">
            </div>
          </div>
          <div class="form-group {{ $errors->has('tpp_dibayarkan') ? 'has-error' : '' }}">
            <label class="col-sm-3 control-label">TPP Dibayarkan</label>
            <div class="col-sm-9">
              <input type="text" name="tpp_dibayarkan" class="form-control" value="{{ $pegawai->tpp_dibayarkan }}" onkeypress="return isNumber(event)" maxlength="8" placeholder="@if($errors->has('tpp_dibayarkan')){{ $errors->first('tpp_dibayarkan')}}@endif TPP Dibayarkan">
            </div>
          </div>
        </div>
